...
curl_setopt($ch, CURLOPT_POSTFIELDS, http_build_query(array('secret' => '6LdND8IZAAAAACL7ifTNPigZ_rWHRCZwcZ6RVU_G', 'response' => $token)));
...
if($arrResponse["success"] == '1' && $arrResponse["action"] == $action && $arrResponse["score"] >= 0.5) {
    ...
    array_push($errors, "you are a robot");
} 
